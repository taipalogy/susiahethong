...
Naw siw behf congy 一 ez 通用 ez 標準書寫系統, pitfsuz aiy khurfluw ifhaw 事項: 拍字利便, 手寫利便, 讀 khih laih 輕鬆, 外來語 ew 書寫, 字典順序 ew 設計, anfchuann 排版 khahf suiy, tiw 電子冊 tingfkuanx behf anfchuann 顯示 khahf 清楚.
...
台語語音辨識 ew 重點 siw 單語分割, tiurhw siw anfchuann kaw 一个一个單語辨識 cut laih. A 單語分割 ew 基礎 tiurhw siw 台語 ew 單位 aiy 詳細 kaw 規定. 譬喻 kong 啥乜 siw 一字, 啥乜 siw 一个單語, 啥乜 siw 一句, 啥乜 siw 一个片語, 啥物是一个文, long aiy kaz 規定好勢. Ia kurhf uw 繼續調 kahf 原調 (終止調) ew 對照 maw siw aiy 斟酌處理.

### 無聲調書寫

Uw chitwkua 輸入法 ew iongw 無聲調 ew 方式 suzjipw 文字, 譬如 kong 書寫系統 chitf 字 ewtangy iongw "susiahethong" 輸入. Uw chitwkua 場合 siw behf kahf 韓語, 日語 chury 對照, maw ewtangy iongw 無聲調 ew 書寫型式, 譬喻 kong 韓國話 ew hanja, 日語 ew kanji, kahf 台語 ew hanji.
...
Chitflez 區別 kahf 語源 (etymology) 有關. 一个書寫系統 behf anfchuann 區別 burzkanz 來源 ew 語彙, siw mw siw ewtangy iongw 聲調 laiz 區別. 外來語 ew 書寫 behf anfchuann piaufsiw 屈折性 kahf 語尾變化.

台語內底 uw cinzciunnw 'otobai' chitf 種 ew 外來語. Sofi tiw le sietfkey 書寫系統 ew 時拵, ewtangy sunwsuay khurfluw 外來語 ew 處理 kahf 書寫, kienylipw 一套符號轉換 ew 規則. 外來語 kahf 固有語 ewtangy liwiongw 分別 ew 方式書寫, anfne tiw 視覺上 ewtangy 區別. 譬喻 kong iongw 無仝欵 ew 符號.

### 字辭典 ew 編排

Uw 幾个首字母 ewtangy thehw laiz 用. Behf anfchuann liwiongw chuanzpow 26 个字母. Anfchuann liwiongw 羅馬字 ew 特性 laiz piaufhienw 台語. Anfchuann thezsingz 查字典 ew 速度 kahf 效率.
...
鼻音化記號 siw iongw -nn 表示, tiw 設計上 kurhf ewtangy khurfluz iongw -nr 代替. A 語根 nng khuanny siw mw siw ewtangy iongw lng 代替, anfne tiw parser 內底 ew 處理 ew kurhf khahf 水氣.
...
Kaw 字放大縮小, anfne 字看 khih laih kam iuzuanz 好勢, kam ew 清楚.

### 聲調號碼 kam suziauy kahf alphabet ew 順序仝欵

Che siw khahf 字典 ew 編排 kahf uw 關係. 譬喻 kong, piaufsiw 第二調 ew 聲調符號 y kahf piaufsiw 第三調 ew 聲調符號 w, inz tiw alphabet 內底 siw w tiw y ew 頭前. 號碼 ew 順序 kahf alphabet ew 順序 ew ingfhiong 書寫系統 ew 設計.
...
字母 d punflaiz ingykaiz siw 濁音, ingw laiz suzsia 外來語 siw 無問題.
